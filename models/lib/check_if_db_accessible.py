...
def isdbaccessible(host_server,db_server):
    try:
    ...
    try:
        ...
        sftp.put("/opt/odoo12/webkul_addons/odoo_saas_kit/models/lib/connect_db.py",'/tmp/connect_db.py')
        sftp.close()
...
'''
isdbaccessible(host_server =  {'user': 'odoo12', 'host':
    '192.168.10.214', 'server_type': 'remote', 'password': 'odoo12', 'port':
    '22'},db_server = {'user': 'odoo', 'host':
        '192.168.1.96', 'server_type': 'remote', 'password': 'odoo',
        'port': '5432'})
'''
